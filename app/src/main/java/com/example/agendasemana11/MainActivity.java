...
public class MainActivity extends AppCompatActivity {
    ...
    public void nuevo_agenda() {
        Intent agregar_agenda = new Intent(MainActivity.this, AgregarAgenda.class);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        @Override
            ...
            try {
                ...
                Toast.makeText(MainActivity.this,"Error al enviar la red"+ ex.getMessage().toString(),Toast.LENGTH_LONG);
            }
